...
class MnistBatchProvider:
    ...
    def __init__(self, initial_batch_size, sesop_private_dataset):
        ...
        self.custom_runner = CustomRunner(train_data[0], train_data[1],
                                          ...
                                          initial_batch_size, self.sesop_dataset_size)
    ...
    def set_data_source(self, sess, data_name='train'):
        if data_name == 'test':
            ...
            assert (data_name == 'sesop' and self.sesop_private_dataset == False)
            self.custom_runner.set_data_source(sess, 2)
